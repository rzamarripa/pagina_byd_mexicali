...
import yuan_pro_dmi from "@/assets/images/header-product-images/yuan-pro-dmi.webp";
...
export const electricVehicles: Vehicle[] = [
  {
    carPicturePath: sealion,
    carName: "BYD SEALION 7 EV",
    text: "Conócelo",
    link: "/car/sealion-7-ev",
  },
  // {
...
export const hybridVehicles: Vehicle[] = [
  ...
  {
    carPicturePath: yuan_pro_dmi,
    carName: "BYD YUAN PRO DM-i",
    text: "Conócelo",
    link: "/car/yuan-pro-dmi",
  },
];
